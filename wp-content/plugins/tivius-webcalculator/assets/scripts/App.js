...
const { API_URL, fetchOptions, ValidationErrors } = Constants;
...
class App extends Component{
  ...
  render() {
    ...
    const validationSummaryHeaderText = ValidationErrors.VALIDATION_SUMMARY_HEADER_TEXT;
  ...
  /> ) : '';
    return (
     <div>
       <InputForm submitForm={this.submitForm}
         raiseValidationError={this.raiseValidationError}
