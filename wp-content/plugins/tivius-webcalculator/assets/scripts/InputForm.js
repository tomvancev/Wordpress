...
class InputForm extends Component {
    ...
    { key:3, text: 'Површина во m2', name:'povrsina', type:InputType.NUMBER, errorText: ValidationErrors.AREA },
    { key:4, text: 'Висина во cm', name:'visina', type:InputType.NUMBER, errorText: ValidationErrors.HEIGHT },
    { key:5, text: 'Дебелина на изолација', name:'izolacija', type:InputType.SELECT, errorText: ValidationErrors.ISOLATION,
				options: [
